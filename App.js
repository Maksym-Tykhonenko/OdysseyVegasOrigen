...
//////////////////////////////////////////
import OdysseyVegasOrigenProdactScreen from './screens/OdysseyVegasOrigenProdactScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://impressive-royal-satisfaction.space/`;
  const URL_IDENTIFAIRE = `g6Fmcf2M`;
  ...
  OneSignal.initialize('c469e981-9a11-4bd2-9ca6-df9a72caf557');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="OdysseyVegasOrigenProdactScreen"
            component={OdysseyVegasOrigenProdactScreen}
